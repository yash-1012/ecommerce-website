                ...
                <div class="box">
					...
					<?php
						if(isset($_POST['confirm_payment'])){
							...
							$ref_no=$_POST['trfr_number'];
							$payment_date=$_POST['date'];
							$amount=$_POST['amount'];
							$complete="complete";
							$insert="INSERT INTO `payments` (`invoice_no`, `payment_mode`, `ref_no`, `payment_date`, `amount`) VALUES ('{$invoice_no}', '{$payment_mode}', '{$ref_no}','{$payment_date}', '{$amount}')";
							$run_insert=mysqli_query($conn,$insert);
							$update_q="UPDATE customer_order SET order_status='$complete' WHERE order_id='$order_id'";
							$run_update=mysqli_query($conn,$update_q);
							// $update_pen_q="UPDATE pending_order SET order_status='$complete' WHERE order_id='$order_id'";
							// $run_update=mysqli_query($conn,$update_pen_q);
