        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-fw fa-money"></i> New Order
                </h3>
            </div>
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $i ?></td>
                                <td>
                                    <?php $get_cust="SELECT * FROM customers WHERE customer_id='$customer_id'";
        ...
        <div class="panel">
            <div class=panel-body">
                <div class="thumb-info mb-md">
                    <!-- <img src="admin_images/<?php echo $admin_image ?>" alt="admin image" class="rounded img-responsive"> -->
